...
public class Probe {
	...
	List<FilePriority> lstFilePriority;
	...
	public List<FilePriority> getLstFilePriority() {
		return lstFilePriority;
	}
	public void setLstFilePriority(List<FilePriority> lstFilePriority) {
		this.lstFilePriority = lstFilePriority;
	}
